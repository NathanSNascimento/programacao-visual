...
procedure TFCadCores.DBGrid1DblClick(Sender: TObject);
begin
...
begin
  ...
  begin
    FDQCores.Close;
    FDQCores.SQL.Clear;
    FDQCores.SQL.Add('SELECT * FROM CAD_CORES WHERE ID_COR = :Pid');
    FDQCores.ParamByName('pid').Value := 0;
    FDQCores.Open;
  end;
...
procedure TFCadCores.FormClose(Sender: TObject; var Action: TCloseAction);
begin
  FCadCores.Destroy;
  DMConnCor.Destroy;
end;
